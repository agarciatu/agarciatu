...
DETECT_IDU = os.path.join(TOP_DIR, "resources/idu.wav")
...
def play_audio_file_idu(fname=DETECT_IDU):
...
def play_audio_file_init(fname=DETECT_DONG):
    """Simple callback function to play a wave file. By default it plays
    a Ding sound.
